...
public class LoginActivity extends Activity {
    ...
    String IP_Server="boyanes90.0fees.us";//IP DE NUESTRO PC
    ...
    public void err_login(){
        ...
        Toast toast1 = Toast.makeText(getApplicationContext(),"Error: Username or password incorrect", Toast.LENGTH_SHORT);
        toast1.show();
    }
